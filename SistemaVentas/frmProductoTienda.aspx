                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                  <div class="form-group mb-0">
                                    <label for="txtRuc" class="col-form-label col-form-label-sm">CUIT:</label>
                                    <input type="text" class="form-control form-control-sm model" readonly id="txtRuc" name="CUIT">
                                  </div>
                                </div>
                                <div class="col-sm-3">
                                  <div class="form-group mb-0">
